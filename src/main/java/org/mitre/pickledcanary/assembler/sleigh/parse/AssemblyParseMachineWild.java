...
import org.mitre.pickledcanary.assembler.sleigh.grammars.AssemblyProduction;
import org.mitre.pickledcanary.assembler.sleigh.grammars.AssemblySentential;
import org.mitre.pickledcanary.assembler.sleigh.grammars.AssemblySentential.TruncatedWhiteSpaceParseToken;
import org.mitre.pickledcanary.assembler.sleigh.parse.AssemblyParseActionGotoTable.*;
import org.mitre.pickledcanary.assembler.sleigh.symbol.*;
import org.mitre.pickledcanary.assembler.sleigh.tree.*;
...
public class AssemblyParseMachineWild implements Comparable<AssemblyParseMachineWild> {
	...
	private boolean termIsValidForWildcard(AssemblyTerminal t) {
		return !t.getClass().getName().equals("org.mitre.pickledcanary.assembler.sleigh.grammars.AssemblySentential$WhiteSpace");
	}
